    ...
    public PowerShell configuration(Map<String, String> config) {
        try {
            this.waitPause = Integer
                    .parseInt((config != null && config.get("waitPause") != null) ? config.get("waitPause")
                            : System.getProperty("waitPause"));
            this.maxWait = Long.parseLong((config != null && config.get("maxWait") != null) ? config.get("maxWait")
                    : System.getProperty("maxWait"));
            this.tempFolder = (config != null && config.get("tempFolder") != null) ? getTempFolder(config.get("tempFolder"))
                    : getTempFolder(System.getProperty("tempFolder"));
            ...
            try {
                ...
                if (this.threadpool != null) {
                    try {
                        ...
                        boolean terwait = this.threadpool.awaitTermination(5, TimeUnit.SECONDS);
