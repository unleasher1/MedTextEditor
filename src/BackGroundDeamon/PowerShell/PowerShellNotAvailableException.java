...
public class PowerShellNotAvailableException extends Exception {
    /**
     ...
     * @since 1.7
     */
    public PowerShellNotAvailableException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
